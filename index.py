...
# Seconds to wait after starting the Flask thread before opening the browser.
# Flask binds its socket asynchronously; without this delay the browser may
# attempt to connect before the server is ready to accept requests.
FLASK_STARTUP_DELAY_SECONDS = 0.5
...
def main():
    ...
    time.sleep(FLASK_STARTUP_DELAY_SECONDS)
